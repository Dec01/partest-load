...
def percentile(values: Sequence[float], q: float) -> float:
    ...
    ранг, и обе величины назывались p95. Потребитель, сводящий замеры семейства, сравнивает
    p95 нагрузочного замера с p95 из покрытия: сравнивались бы два разных числа, и
    расхождение было бы не в пределах шума.
