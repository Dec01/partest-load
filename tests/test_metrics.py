...
def test_percentile_uses_nearest_rank_like_the_rest_of_the_family():
    ...
    ближайший ранг. Обе величины звались p95, а потребитель, сводящий замеры семейства,
    сравнивает p95 нагрузочного замера с p95 из покрытия: сравнивались бы два разных числа.
